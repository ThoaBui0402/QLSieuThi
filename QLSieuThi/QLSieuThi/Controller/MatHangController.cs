...
{
    class MatHangControllercs
    {
        private static MatHangControllercs instance;
        public static MatHangControllercs Instance
        {
            get
            {
                if (instance == null)
                    instance = new MatHangControllercs();
                return MatHangControllercs.instance;
            }
            private set { MatHangControllercs.instance = value; }
        }

        private MatHangControllercs() { }
        // xem mat hang
